		...
		<div className="headerWrapper">
			...
			<div className="headerRight">
				...
				<div className="user_info">
					{loginStatus ? (
						<img src={currentUser.avatar ? currentUser.avatar : avatar} className="user_infoTitle"></img>
					) : (
						<p>
					...
					{open && (
						<nav className="navBar">
							<ul>
								...
								<li className="navLi">
									<NavLink to="/detail" style={({ isActive }) => (isActive ? activeStyle : undefined)}>
										Detail
									</NavLink>
								</li>
								<li className="navLi">
								...
								<li className="navLi">
									<NavLink onClick={onClickLogOut} to="/">
										{({ isActive }) => <span style={isActive ? activeStyle : undefined}>Logout</span>}
									</NavLink>
								</li>
							</ul>
						</nav>
